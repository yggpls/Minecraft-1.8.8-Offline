...
an actual remake of BSS on ka

now updated with beesmas
...
<div id='abilityUI' style='margin:5px;padding:0px;margin-top:35px;position:fixed;pointer-events:none;'>
   ...
   <svg id='redBombSync' style='width:30px;height:30px;display:none'>
    ...
    <div class='uiPage' style='pointer-events:auto;margin:0px;z-index:-2;overflow-y:auto;overflow-x:hidden;width:205px;height:455px;background-color:rgba(195,195,195,0.9);margin-top:5px;display:none;padding:3px;font-size:13px;'>
        ...
        <div style="margin-top:5px;background-color:rgb(170,170,170);font-size:15px;border-radius:3px;">Sensitivity: <input id='sensitivitySetting' type='number' value='10' min='0' max='100' style='background-color:rgb(255,255,255,0.5);padding-left:4px;width:40px;transform:scale(0.8,0.8);font-family:comic sans ms'></div>
...
<script src="https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.2/resources/gl-matrix-min.js"></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.2/resources/cannon.min.js'></script>
<script src="https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.2/resources/canvg.min.js"></script>


<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/dialogue.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/textures.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/playerGear.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/MathHelper.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/GLSLShaders.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/mapMesh.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/thumbnail.js'></script>
<script src='https://cdn.jsdelivr.net/gh/Dddatt/bss@v3.0.3/index.js'></script>
